...
# API Key & Image Base URL for TMDB API
...
# Select movie with a unique key to avoid duplicate widget errors
selected_movie = st.selectbox("Choose a movie:", movies["title"].values, key='movie_selectbox_unique')
...
if st.button("🚀 Let’s Go"):
    ...
    st.session_state.expanded_movie = None  # Reset opened movie on new search
